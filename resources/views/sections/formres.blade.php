    <!-- Bloc de reservation -->
    <div class="blocs">
        <div class="reservation-card" data-aos="fade-up" data-aos-duration="1200">
            <div class=" container">
                ...
                <form id="resForm" method="post" action="/reservation" target="_self">
                    @csrf
                    <div class="mb-4 ml-1">
                        <label for="res_name"></label>
                        <input type="text" required name="name" placeholder="Nom complet" class="form-input"
                            id="name" value="" />
